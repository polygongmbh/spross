...
/**
 * The audio half of [CatalogFixtureTest] — how a manifest parses, over the synthetic
 * [AudioFixture], which owns its values so they can be pinned exactly.
 * Lookup, utterance and credits are [CatalogAudioLookupTest];
 * real-catalog rules live in `CatalogAudioLintTest`.
 */
class CatalogAudioParseTest {
