 ...
 */
class NumbersDateReadingTests {

    private fun readings(language: String, day: Int): List<String> = Numbers.pack(language).dateDay(day)
    ...
    private fun years(language: String, year: Long): List<String> = Numbers.pack(language).dateYear(year)
