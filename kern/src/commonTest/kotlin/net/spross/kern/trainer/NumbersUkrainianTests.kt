 ...
 */
class NumbersUkrainianTests {

    private fun number(n: Long) = Numbers.number(n, "uk")
    private fun clock(h: Int, m: Int) = Numbers.clock(h, m, "uk")
    ...
    fun yearsUsePlainCardinalReading() {
        ...
        assertEquals("дві тисячі двадцять шість", Numbers.year(2026, "uk").display)
    }
