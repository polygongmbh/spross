...
internal object ChromeEn : Chrome {
    ...
    override val trainerHubTitle = "Meadow"
    override val trainerHubSubtitle = "Playful practice, whenever you are up for it"
    override val a11ySuffixPractice = " practice, in %s"
    override val trainerDrillLetters = "Letters"
    ...
    override val trainerDrillNumbers = "Numbers"
    ...
    override val numbersSprosseOne = "🔢 %d digit"
    override val numbersSprosse = "🔢 %d digits"
    ...
    override val a11yLettersAlphabetSpeakName = "Hear the name"
    override val a11yLettersAlphabetSpeakExample = "Hear the example"
    override val trainerDrillCountries = "Countries"
    ...
    override val trainerDrillDates = "Dates"
    ...
    override val boxName = "Your Orchard"
    ...
    override val boxOwnWordExplainerRemark = "A note only: it goes to the catalog and is " +
        "never asked."
    override val a11yBoxShelfPack = "Sow (%s)"
    override val a11yBoxShelfPacked = "All sown"
    override val boxCardShowInBox = "Show in the catalog"
    override val boxCardPack = "Sow this word"
    override val boxCardUnpack = "Take this word back"
    override val a11yBoxShelfUnpack = "Take back (%s)"
    override val boxCardQueued = "Sown"
    override val a11yBoxCardSuspended = "Paused"
    ...
    override val boxSearchNothing = "Nothing for “%s” in the catalog."
    ...
    override val boxOwnMatchMerge = "Merge %d"
    ...
    override val settingsProfileSwitching = "Switching…"
