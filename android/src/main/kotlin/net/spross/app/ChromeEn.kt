...
internal val ChromeEn = Chrome(
    ...
    countriesPace = "Every run opens at rung 1 and climbs on by itself.",
    countriesBest = "Furthest so far: rung %d",
    countriesFastHint = "One clean answer per rung instead of three.",
