...
internal object ChromeEn : Chrome {
    ...
    override val sourceQuestion = "Which language do you speak?"
    override val targetQuestion = "Which language are you learning?"
    ...
    override val feminineForm = "Feminine form"
    ...
    override val practiceSuffix = " practice, in %s"
    override val trainerLetters = "Letters"
    ...
    override val notAnswered = "Not answered"
    override val close = "Close"
    override val trainerNumbers = "Numbers"
    ...
    override val trainerCountries = "Countries"
    ...
    override val ownWordEdit = "Edit word"
    override val ownWordSave = "Save"
    override val ownWordSwap = "Swap direction"
    override val ownWordSuggestion = "One side only: the word is kept as a suggestion and " +
        "not asked yet."
    ...
    override val ownContentTitle = "Your own content"
    override val ownContentReported = "Reported"
    override val ownWordAddAction = "Add a word"
    override val feedbackNeedsTranslation = "Needs translation"
    override val feedbackCopy = "Copy"
    override val feedbackSend = "Send"
    override val feedbackScopeNew = "Only what is new"
    override val feedbackScopeAll = "Everything"
    ...
    override val cardPosition = "Card %1\$s of %2\$s"
    override val sessionTally = "%1\$s correct, %2\$s hard, %3\$s wrong"
