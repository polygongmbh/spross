...
/// Check/tile tap. The numbers and the screen-reader skip live here once so
/// a new surface cannot mint a second timing or forget the guard.
enum AutoAdvance {
    ...
    static let liveDelay: Duration = .milliseconds(450)
    ...
    /// the screen moves.
    static let explicitDelay: Duration = .milliseconds(1200)
