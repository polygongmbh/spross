...
Each ladder itself is kern's — `Trainer`/`DrillRamp`, `CountryDrill`, `DateDrill` —
...
- **The reference table is generated by `Trainer.reference`** from the packs the drill grades
