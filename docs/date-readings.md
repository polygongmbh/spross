...
(`drills-tables.md` § Datum) — the year-in-a-date rule, and the per-language date usage rulings.
...
The canonical and accepted day readings below are pinned by `NumbersDateReadingTests`.
