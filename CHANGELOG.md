...
- Two new Sprossen: Word scramble writes a word you already hold back out of its mixed-up letters, and Sentence scramble taps a phrase's words back into order — neither touches when your box is due.
...
- Everyday glue words that only ever hid inside phrases now have cards of their own, among them later, last, since, therefore, nowadays, a little, must, put and the possessives my, your and his.
...
- A long press on a word in the Box also shows the other words for it and how long it keeps.
...
- **Spross installs from its own releases now, on either phone.** Every tagged version
  ...
  through TestFlight, or over the air on a registered device. No store, no cable.
